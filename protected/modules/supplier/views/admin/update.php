 ...
 **/
    $this->breadcrumbs = array(
        ...
        $model->id => array('/supplier/admin/view', 'id' => $model->id),
        Yii::t('supplier', 'Редактирование'),
    );

    $this->pageTitle = Yii::t('supplier', 'Постащики - редактирование');
...
<div class="page-header">
    <h1>
        <?php echo Yii::t('supplier', 'Редактирование') . ' ' . Yii::t('supplier', 'Поставшика'); ?><br />
